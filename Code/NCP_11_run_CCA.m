function [var,pval,weights,res,Y_pred] = NCP_11_run_CCA(X,Y,cfg,molecular_names_table,dx_title,X_rot_ordered,type)
...
%     
    ...
    if length(cfg.machine.param.(cfg.machine.param.name{1})) == 1
...
%             set(gca, 'FontSize', 11);
            ...
            weights = plot_weight(res, 'X', 'behav', res.frwork.split.best, 'behav_vert', type, ...
                'gen.figure.Position', [100 200 1200 500], ...
                'gen.axes.FontSize', 35, 'gen.legend.FontSize', 20, ...
